                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" value="{{$data->customer_name}}" readonly class="form-control"  name="general">
                                ...
                                <div style="display:none " id="addpayment">
                                    <div class="col-sm-6">
                                        <div class="form-group fg-line">
                                            ...
                                            {!! Form::select("paymode", [''=>'Select Payment Mode','1' => 'Cash','2' => 'Account', '3' => 'Paytm', '4' => 'Phone Pay', '5' => 'Google Pay','6'=>'Adhar Card'], 'old("payment_mode")', ['class'=>'selectpicker isRequred', 'id'=>'paymode' ,'data-dropup-auto'=>"false" ]  ) !!}
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group fg-line">
