                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body card-padding ">
                            <section>
                                <div class="card-body">
                                    <!-- सेल ब्याज Receipt Company Details -->
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 col-12 pull-right">
                                            <span
                                                style="font-size:15px"> Receipt No. {{$sale_interest->rec_no}}</span><br>
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-sm-12 col-12 text-left">
                                            <h4 class=""
                                                ...
                                                sum
                                                of Rupees <span
                                                    style="font-size: 20px; text-decoration: underline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ₹ {{$sale_interest->interest_amount}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>by
                                                Cash/Cheque/Draft No
                                                Date:<span
                                                    style="font-size: 20px; text-decoration: underline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{date('d-M-Y',strtotime($sale_interest->updated_at))}} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>.
                                            </h4>
                                        </div>
                                    </div>
                                    <!--/ Invoice Recipient Details -->
                                        ...
                                        <div class="container-fluid">
                                            <div class="col-sm-3" style="border: 2px solid grey">
                                                        <span class="text-center font-weight-bold ml-1"
                                                              style="font-size: 30px">₹ {{$sale_interest->interest_amount}} </span>
                                            </div>
                                        </div>
                                    </div>
