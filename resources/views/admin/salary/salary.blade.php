                ...
                <div class="block-header m-t-20 m-l-5">
                    <div class="col-sm-3">
                        <div class="block-header m-t-5 ">
                            <h2>सेल्समेन वेतन Generate करें</h2>
                        </div>
                    </div>
                    {!! Form::open(['route'=>'salaryStore','method'=>'post','onsubmit'=>'submitBtn.disabled = true','return'=>true]) !!}
                    <div class="col-sm-8">
                    ...
                    <div class="col-sm-1">
                        <div class="btn-group pull-right">
                            <button class="btn btn-primary btn-block"> Submit करें</button>
