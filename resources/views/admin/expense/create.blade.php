                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body card-padding">
                            {!! Form::open(['route'=>'expense.store','method'=>'post','onsubmit'=>'submitBtn.disabled = true','return'=>true]) !!}
                            <div class="row">
                                <div class="col-sm-6 ">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group fg-line">
                                        ...
                                        {!! Form::select('salesman_id', [''=>'सेल्समेन चुने ']+$salesman, old('salesman_id'), ['id'=>'salesman_id'  , 'class'=>'selectpicker' ,'data-dropup-auto'=>"false",'data-live-search'=>'true']) !!}
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" name="expense_date" id="expense_date"
                                               value="{{old('expense_date',date('d-M-Y'))}}"
