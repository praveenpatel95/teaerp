                            ...
                            <div class="row">
                                <div class="col-sm-6 ">
                                    <div class="form-group fg-line">
                                        ...
                                        {!!form::select('product_id',[''=>'Select']+$product,old('product_id'),['required','id'=>'product_id','class'=>'selectpicker','data-dropup-auto'=>"false" ,'data-live-search'=>'true']) !!}
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" id="purchase_date"
                                               ...
                                               required="" value="{{old('purchase_date',date('d-M-Y'))}}">
