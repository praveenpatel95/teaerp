...
@section('title', 'एडवांस पेमेंट जोड़े')
@push('headerscript')
    <link
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body card-padding">
                            {!! Form::open(['route'=>'advancepayment.store','method'=>'post','onsubmit'=>'submitBtn.disabled = true','return'=>true]) !!}
                            <div class="row">
                                <div class="col-sm-6 ">
                                ...
                                <div class="col-sm-3 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" id="adv_date"
                                               ...
                                               required="" value="{{old('adv_date',date('d-M-Y H:i:s'))}}">
                                ...
                                <div class="col-sm-12 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <textarea type="text" name="remark" id="remark"
                                                  class="form-control " maxlength="">{{old('amount')}}</textarea>
