                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body card-padding">
                            {!! Form::open(['route'=>array('product.update',$product->id),'method'=>'put','onsubmit'=>'submitBtn.disabled = true','return'=>true]) !!}
                            <div class="row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-2 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" name="in_stock" id="in_stock" class="form-control number"
                                               required="" value="{{old('in_stock',$product->in_stock)}}">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" name="purchase_price" id="purchase_price"
                                               required=""  value="{{old('purchase_price',$product->purchase_price)}}" class="form-control floatnumber">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group fg-line">
                                        ...
                                        <input type="text" name="sale_price" id="sale_price" class="form-control floatnumber"  value="{{old('sale_price',$product->sale_price)}}"
                                               required="" >
