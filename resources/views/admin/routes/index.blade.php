                ...
                <div class="col-sm-12">
                    <div class="block-header m-t-20 m-l-5">
                        <div class="btn-group pull-right">
                            <a class="btn btn-primary btn-block" href="{{route('routes.create')}}"><i
                                    class="zmdi zmdi-plus"></i> रूट जोड़े</a>
                        </div>
